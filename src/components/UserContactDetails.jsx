    ...
    <section className="user-contact-details">
      <ul className="contact-details-list">
          ...
          <div className="svg-container">
            <svg height="20" width="14" xmlns="http://www.w3.org/2000/svg">
              <path
                ...
                fill={location ? "currentColor" : inActiveColor}
              />
            </svg>
          </div>
          <a
        ...
        <li className="contact-item">
          <div className="svg-container">
            <svg height="20" width="20" xmlns="http://www.w3.org/2000/svg">
              <g fill={website ? "currentColor" : inActiveColor}>
          ...
          <div className="svg-container">
            <svg height="18" width="20" xmlns="http://www.w3.org/2000/svg">
              <path
                ...
                fill={twitter ? "currentColor" : inActiveColor}
              />
            </svg>
          </div>
          <a
        ...
        <li className="contact-item">
          <div className="svg-container">
            <svg height="20" width="20" xmlns="http://www.w3.org/2000/svg">
              <g fill={company ? "currentColor" : inActiveColor}>
